// world/merchants.js
// ------------------------------------------------------------
// Traveling Merchants + Base Merchant Generator (Browser Safe)
// ------------------------------------------------------------

// getReputation is provided globally by world/reputation.js
// so we reference it directly from window.*
...
function rollMerchantEncounter(worldState, location, weather) {
  const rep = window.getReputation(worldState, location.faction);
...
// ------------------------------------------------------------
// Expose globally for world.js and adapters
// ------------------------------------------------------------
window.pickMerchantFor = pickMerchantFor;
window.rollMerchantEncounter = rollMerchantEncounter;
window.merchantGreeting = merchantGreeting;
